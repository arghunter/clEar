...
def generate_pdm_sinewave(frequency, pdm_rate, duration):
    """
...
output_file = 'pdm_sinewave.txt'  # Output file name

# Generate the PDM sine wave
pdm_sinewave = generate_pdm_sinewave(frequency, pdm_rate, duration)
